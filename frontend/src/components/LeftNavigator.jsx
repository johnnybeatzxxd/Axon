...
export default function LeftNavigator({
  ...
  return (
    <aside className={isCollapsed ? 'left-nav left-nav--collapsed' : 'left-nav'} role="complementary">
      ...
      <div className="left-nav__bottom">
        <button className="dock-toggle" onClick={onToggleCollapsed} aria-label="Toggle navigator">
          {isCollapsed ? (
