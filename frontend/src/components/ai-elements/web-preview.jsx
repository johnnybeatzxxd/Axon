...
export const WebPreviewBody = ({
  ...
  // Determine the correct props for the iframe
  const iframeProps = {};
  if (srcDoc) {
    // If srcDoc is provided, use it. This takes priority.
    iframeProps.srcDoc = srcDoc;
  } else {
    // Otherwise, fall back to the src/url behavior.
    iframeProps.src = (src ?? url) || undefined;
  }
  return (
    <div className="flex-1">
      <iframe
        ...
        // Spread the determined props onto the iframe
        {...iframeProps}
        {...props} />
      {loading}
    </div>
